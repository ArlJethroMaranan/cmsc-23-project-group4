...
import 'package:cmsc_23_proj/models/org_model.dart';
          ...
          builder: (context, snapshot) {
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                OrgModel temp = OrgModel.fromJson(
                    snapshot.data!.docs[index].data() as Map<String, dynamic>);

                Widget canDonateButton = temp.status == "Open"
                    ? ElevatedButton(
                        onPressed: () async {
                          await Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (context) =>
                                      DonorsDonate(orgID: temp.orgID!)));
                        },
                        child: Text('Donate'))
                    : SizedBox
                        .shrink(); // if the status is open then the elevated button will show so that users can donate
                  ...
                  child: ExpansionTile(
                    ...
                    children: [
                      ...
                      Padding(
                        padding: const EdgeInsets.all(16),
                        child:
                            canDonateButton, // call can donate button from widget above
                      ),
                    ],
                  ),
                );
