...
class _ProfileOrgState extends State<ProfileOrg> {
  ...
  Widget build(BuildContext context) {
    Stream<QuerySnapshot> profileOrgStream =
        context.watch<OrgProfileProvider>().profileOrg;
          ...
          builder: (context, snapshot) {
            ...
            return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  OrgProfileModel temp = OrgProfileModel.fromJson(
                        ...
                        Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              const Center(
                                child: Text("testemail@gmail.com",
                                    style: TextStyle(
                                        fontSize: 20,
                              ...
                              Column(
                                children: [
                                  ...
                                  Column(
                                    children: statusForDono.map((status) {
                                      ...
                                      return ListTile(
                                        ...
                                        leading: Radio<String>(
                                          value: status,
                                          groupValue: temp
                                              .status, // points to currently picked
                                          onChanged: (value) {
                                            setState(() {
                                              temp.status =
