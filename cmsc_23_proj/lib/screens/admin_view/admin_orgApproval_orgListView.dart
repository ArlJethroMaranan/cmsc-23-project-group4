...
class _OrgForApprovalListViewState extends State<OrgForApprovalListView> {
  ...
  Widget build(BuildContext context) {
    Stream<QuerySnapshot> orgsForApprovalStream =
        context.watch<OrgsForApprovalListProvider>().orgsForApproval;
        ...
        builder: (context, snapshot) {
          ...
          return ListView.builder(
              ...
              itemBuilder: ((context, index) {
                OrgForApproval temp = OrgForApproval.fromJson(
                          ...
                          children: [
                            OutlinedButton(
                              style: OutlinedButton.styleFrom(
                                  backgroundColor:
                                      const Color.fromARGB(255, 229, 239, 95)),
                              onPressed: () async {
                                Stream<QuerySnapshot> orgList = context
                                    .read<OrganizationsListProvider>()
                                    .organization;
                                    ...
                                    builder: (BuildContext context) => (Dialog(
                                        child: Padding(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                Text(
                                                    "Organization: ${temp.name} approved!"),
                                                TextButton(
                                                  onPressed: () {
                                ...
                                context
                                    .read<OrgsForApprovalListProvider>()
                                    .deleteOrgForApproval(temp.id!);
                              },
                              child: Text("Approve"),
                            ),
                            OutlinedButton(
                                    ...
                                    builder: (BuildContext context) => (Dialog(
                                        child: Padding(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                Text(
                                                    "Organization: ${temp.name} disapproved!"),
                                                TextButton(
                                                  onPressed: () {
                                                    Navigator.pop(context);
                                                  },
        ...
        body: Container(
          ...
          child: Column(children: [
            Padding(
                ...
                child: Row(
                  children: [Text("About: "), Text("${organization.about}")],
                )),
            const Padding(
              padding: EdgeInsets.all(16),
              child: Text(
                  "Proofs of Legitimacy"), //can do gridbuilder to show pics
            ),
